...
<section class="panel panel--history arc-background arc-background--history arc-background--left-teal-light">
  ...
  <p class="p--body">
Operation of AirBeam Mini is nearly identical to operation of AirBeam3, so the below videos can be used with AirBeam Mini.  However, please note that AirBeam Mini does not have a cellular or GPS module, so instructions related to fixed-cellular mode and standalone location tracking should be disregarded.<br />
