...
<section class="panel panel--history arc-background arc-background--history arc-background--left-teal-light">
  ...
  <img class="p--body" src="{{ site.baseurl | append: '/assets/img/users-guide/PA_Plots.jpg' | append: '?nf-resize=fit=1200' }}" alt="PurpleAir Plots" />
  ...
  <img class="p--body" src="{{ site.baseurl | append: '/assets/img/users-guide/NYUSOM_CAPS.jpg' | append: '?nf-resize=fit=1200' }}" alt="NYUSOM CAPS" />
  ...
  <img class="p--body" src="{{ site.baseurl | append: '/assets/img/users-guide/AB_Plots.jpg' | append: '?nf-resize=fit=1200' }}" alt="AirBeam plots" />
